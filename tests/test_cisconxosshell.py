...
class TestCiscoNXOSShellDriver(unittest.TestCase):
    ...
    def test_orchestration_save_no_optional_params(
        ...
        mocked_orch_service.return_value.prepare_orchestration_save_result.return_value = (  # noqa
            ""
        )
        ...
        # Assert
        mocked_orch_service.return_value.prepare_orchestration_save_result.assert_called_once_with(  # noqa
            save_response
        )
    ...
    def test_orchestration_restore_no_custom_params(
        ...
        mocked_class.return_value.restore.return_value = ""
        parse_result = {}
        mocked_orch_service.return_value.parse_orchestration_save_result.return_value = (  # noqa
            parse_result
        )
        ...
        # Assert
        mocked_orch_service.return_value.parse_orchestration_save_result.assert_called_once_with(  # noqa
            saved_artifact_info
        )
